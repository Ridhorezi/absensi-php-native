...
<head>
    ...
    <meta content='width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=0, shrink-to-fit=no'
        name='viewport' />
    <title>Absensi Guru | MDTA Al-Ikhlas</title>
            ...
            <div class="sidebar-wrapper">
                <div class="logo">
                    <a href="<?= base_url() ?>" class="simple-text">
                        <img src="<?= base_url('assets/img/logo.jpeg') ?>" alt="" class="img-fluid">
                    </a>
                </div>
                <ul class="nav">
                    <li class="nav-item">
                        <a class="nav-link text-white">
                            <h2 class="my-0 text-center"><label id="hours"><?= date('H') ?></label>:<label
                                    id="minutes"><?= date('i') ?></label>:<label id="seconds"><?= date('s') ?></label>
                            </h2>
                        </a>
                    </li>
                ...
                <div class="container">
                    <nav>
                        <p class="copyright text-center">
                            &copy; 2023<a href="http://indoexpress.co.id">Vida Sastia</a>
                        </p>
                    </nav>
                </div>
            </footer>
