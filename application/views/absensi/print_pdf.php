                            ...
                            <table class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr <?= (in_array($h['hari'], ['Sabtu', 'Minggu'])) ? 'class="bg-dark text-white"' : '' ?>
                                        ...
                                        <td><?= ($i+1) ?></td>
                                        <td><?= $h['hari'] . ', ' . $h['tgl'] ?></td>
                                        <td><?= (in_array($h['hari'], ['Sabtu', 'Minggu'])) ? 'Libur Akhir Pekan' : check_jam(@$absen_harian['jam_masuk'], 'masuk') ?>
                                        </td>
                                        <td><?= (in_array($h['hari'], ['Sabtu', 'Minggu'])) ? 'Libur Akhir Pekan' : check_jam(@$absen_harian['jam_pulang'], 'pulang') ?>
                                        </td>
                                    </tr>
                                    <?php endforeach; ?>
                                </tbody>
